...
namespace Termin_3
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<DataContext>(options => options.UseSqlServer(Configuration.GetConnectionString("Hr")));
           ...
           .AddJwtBearer(options =>
           {
            ...
            services.AddScoped<ISkillService, SkillServis>();
            services.AddScoped<ICandidatService, CandidatServis>();
